# 🗄️ Create Database Schema in Supabase Dashboard

## ✅ Step 1: Access Your Supabase Dashboard

1. **Go to**: https://supabase.com/dashboard
2. **Sign in** with your GitHub account
3. **Select your project**: `crime-analysis-dashboard`
...
2. **Wait for execution** - this may take a few seconds
3. **Check for success** - you should see "Success" message
...
2. **You should see**:
   - `incidents` table
   - `data_sources` table
3. **Click on "incidents"** to see the table structure

## ✅ Step 6: Test Connection

After creating the schema, run this command:
...
Once the connection test passes, migrate your CSV data:
...
1. **"relation already exists"** - The table was already created, this is fine
2. **"permission denied"** - Make sure you're using the service role key
3. **"connection failed"** - Check your Supabase URL and keys

### Common Issues:

1. **Wrong project selected** - Make sure you're in the right Supabase project
2. **SQL syntax error** - Copy the entire SQL exactly as shown
3. **Network issues** - Try refreshing the page and running again

## 🎉 Success!

Once you see the success message and can verify the tables exist, your database schema is ready for data migration! 